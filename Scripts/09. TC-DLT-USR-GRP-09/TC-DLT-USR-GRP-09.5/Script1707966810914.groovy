...
WebUI.click(findTestObject('Object Repository/0.1 TC-LOG-01/Page_BusyZeus  Add User Group/Page_BusyZeus  User Groups/Page_BusyZeus  User Groups/button_Delete'))
