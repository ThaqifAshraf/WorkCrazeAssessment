...
WebUI.click(findTestObject('Object Repository/0.1 TC-LOG-01/Page_BusyZeus  User Groups/a_Add'))

WebUI.setText(findTestObject('Object Repository/0.1 TC-LOG-01/Page_BusyZeus  Add User Group/input_groupName'), 'Archive Data')

WebUI.setText(findTestObject('Object Repository/0.1 TC-LOG-01/Page_BusyZeus  Add User Group/input_Description'), 'Lorem Ipsum Perol Ghetto ')
